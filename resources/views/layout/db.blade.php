           ...
           <a class="nav-link" data-toggle="collapse" href="{{ '#ui-basic' }}" aria-expanded="false" aria-controls="ui-basic">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/dashboard/product-single">Single Bar</a></li>
                <li class="nav-item"> <a class="nav-link" href="/dashboard/product-blocks">Blocks</a></li>
                <li class="nav-item"> <a class="nav-link" href="/dashboard/product-bags">Bags & boxes</a></li>
                <li class="nav-item"> <a class="nav-link" href="/dashboard/product-drinks">Drinks</a></li>
                <li class="nav-item"> <a class="nav-link" href="/dashboard/product-biscuits">Biscuits</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
